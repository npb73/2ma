...
- ЛКМ — выстрел (только своя цепочка)
- Одиночная игра — без входа, бесконечная до поражения
- Поиск игры / комнаты — после входа
- Уровень: выбор 1 из 3 шаров в пулл (dual / bomb / rainbow / цвета)
- EXP-бар под своей пушкой
